                ...
                <div className="row g-4 justify-content-center">
                    <div className="col-md-3">
                        <div className="card shadow-sm position-relative">
                            ...
                            <img src="/Images/Weather.jpg" className="card-img-top" alt="Weather Software" />
                    ...
                    <div className="col-md-3">
                        <div className="card shadow-sm position-relative">
                            <a href="https://codecrafters.codingwale.in/" className="stretched-link" target="_blank" rel="noopener noreferrer"></a>
                            <img src="/Images/CodeCrafters.png" className="card-img-top" alt="CodeCrafters" />
                            <div className="card-body">
                    ...
                    <div className="col-md-3">
                        <div className="card shadow-sm position-relative">
                            ...
                            <img src="/Images/CarVilla.png" className="card-img-top" alt="CarVilla" />
                            <div className="card-body">
